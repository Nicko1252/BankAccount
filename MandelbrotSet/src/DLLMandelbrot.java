public class DLLMandelbrot {
	...
	public boolean InsertAfter(Node node, double new_data) {
		Node n = new Node(new_data);
		if (first == null) {
			first = n;
			last = n;
	...
	public boolean InsertBefore(Node node, double new_data) {
		Node n = new Node(new_data);
		if (first == null) {
			first = n;
			last = n;
	...
	public void removeRec(Node startNode, double data) {
		Node n = startNode;
		if (first.data == data) {
			removeFirst();
			return;
	...
	public void removeReverse(double data) {
		removeReverseRec(last, data);
	}
	
	public void removeReverseRec(Node startNode, double data) {
		Node n = startNode;
		if (last.data == data) {
			removeLast();
			return;
	...
	public boolean searchRec(Node startNode, double data) {
		Node n = startNode;
		if (first.data == data) {
			return true;
		} else if (n.data == data) {
	...
	public boolean searchReverse(double data) {
		return searchReverseRec(last, data);
	}
	
	public boolean searchReverseRec(Node startNode, double data) {
		Node n = startNode;
		if (last.data == data) {
			return true;
		} else if (n.data == data) {
	...
	public Node findRec(Node startNode, double data) {
		Node n = startNode;
		if (first.data == data) {
			return first;
		} else if (n.data == data) {
	...
	public Node findReverse(double data) {
		return findReverseRec(last, data);
	}

	public Node findReverseRec(Node startNode, double data) {
		Node n = startNode;
		if (last.data == data) {
			return last;
		} else if (n.data == data) {
	...
	public static void main(String[] args) {          
		...
		DLLMandelbrot dll = new DLLMandelbrot();
