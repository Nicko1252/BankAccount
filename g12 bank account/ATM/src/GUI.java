...
public class GUI {
	...
	public JFrame frame;
	public CardLayout layout = new CardLayout(0, 0);
	...
	public JTextField DepositAmtFIELD;
	public JTextField WithdrawAmtFIELD;
	public JTextField TransferAmountFIELD;
	public JTextField TransferAccountFIELD;
...
*/
		...
		JLabel HeadingLabel = new JLabel("Central Reserved Banking Corp.");
		HeadingLabel.setHorizontalAlignment(SwingConstants.CENTER);
		HeadingLabel.setFont(new Font("Bell MT", Font.BOLD, 30));
		...
		LogInBTN.setBounds(10, 100, 416, 23);
		...
		RegisterBTN.setBounds(10, 142, 416, 23);
		TitlePanel.add(RegisterBTN);

		JLabel companyLabel = new JLabel("©. Nick Ostrowka ");
		companyLabel.setHorizontalAlignment(SwingConstants.CENTER);
		companyLabel.setFont(new Font("Bell MT", Font.PLAIN, 18));
		companyLabel.setBounds(2, 228, 150, 31);
		...
		LogInHeadingLabel.setFont(new Font("Bell MT", Font.BOLD, 30));
		...
		AccountNumberLogInLabel.setFont(new Font("Bell MT", Font.BOLD, 20));
		...
		PasswordLogInLabel.setFont(new Font("Bell MT", Font.BOLD, 20));
		...
		SubmitLogInBTN.setForeground(new Color(255, 255, 255));
		SubmitLogInBTN.setBackground(new Color(0, 0, 0));
...
/*
		...
		SubmitLogInBTN.setFont(new Font("Bell MT", Font.BOLD, 15));
		SubmitLogInBTN.setBounds(10, 205, 416, 25);
		LogInPanel.add(SubmitLogInBTN);

		JButton backLogInBTN = new JButton("Back");
		backLogInBTN.setBackground(new Color(0, 0, 0));
		backLogInBTN.setForeground(new Color(255, 255, 255));
		backLogInBTN.setFont(new Font("Bell MT", Font.BOLD, 15));
		...
		RegiserHeadingLabel.setFont(new Font("Bell MT", Font.BOLD, 30));
		...
		FirstNameLabel.setFont(new Font("Bell MT", Font.BOLD, 15));
		...
		LastNameLabel.setFont(new Font("Bell MT", Font.BOLD, 15));
		LastNameLabel.setBounds(0, 127, 432, 14);
		RegisterPanel.add(LastNameLabel);

		JButton FinsihRegisterBTN = new JButton("Register");
		FinsihRegisterBTN.setForeground(new Color(255, 255, 255));
		FinsihRegisterBTN.setBackground(new Color(0, 0, 0));
		FinsihRegisterBTN.setFont(new Font("Bell MT", Font.BOLD, 15));
...
*/
		...
		FinsihRegisterBTN.setBounds(10, 190, 416, 25);
		RegisterPanel.add(FinsihRegisterBTN);

		JButton backRegisterBTN = new JButton("Back");
		backRegisterBTN.setForeground(new Color(255, 255, 255));
		backRegisterBTN.setBackground(new Color(0, 0, 0));
		backRegisterBTN.setFont(new Font("Bell MT", Font.BOLD, 15));
		...
		AccountScreen.setBackground(new Color(128, 128, 128));
		...
		LogOutBTN.setFont(new Font("Bell MT", Font.BOLD, 15));
		...
		LogOutBTN.setBounds(10, 11, 111, 23);
		...
		AccountInfoHeadingLABEL.setFont(new Font("Bell MT", Font.BOLD, 30));
		...
		DepositBTM.setBackground(new Color(0, 0, 0));
		DepositBTM.setForeground(new Color(255, 255, 255));
		DepositBTM.setFont(new Font("Bell MT", Font.BOLD, 15));
		DepositBTM.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JPanel DepositPanel = new JPanel();
				DepositPanel.setBackground(new Color(128, 128, 128));
		...
		DepositBTM.setBounds(10, 72, 416, 23);
		AccountScreen.add(DepositBTM);

		JButton WithdrawBTN = new JButton("Withdraw");
		WithdrawBTN.setForeground(new Color(255, 255, 255));
		WithdrawBTN.setBackground(new Color(0, 0, 0));
		WithdrawBTN.setFont(new Font("Bell MT", Font.BOLD, 15));
		WithdrawBTN.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JPanel WithdrawPanel = new JPanel();
				WithdrawPanel.setBackground(new Color(128, 128, 128));
		...
		WithdrawBTN.setBounds(10, 106, 416, 23);
		...
		TransferBTN.setFont(new Font("Bell MT", Font.BOLD, 15));
		TransferBTN.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {

				JPanel TransferPanel = new JPanel();
				TransferPanel.setBackground(new Color(128, 128, 128));
		...
		TransferBTN.setBounds(10, 140, 416, 23);
		AccountScreen.add(TransferBTN);


		JButton AccountDetailsBTN = new JButton("Account Details");
		AccountDetailsBTN.setBackground(new Color(0, 0, 0));
		AccountDetailsBTN.setForeground(new Color(255, 255, 255));
		AccountDetailsBTN.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {

				JPanel AccountInfoPanel = new JPanel();
				AccountInfoPanel.setBackground(new Color(128, 128, 128));
		...
		AccountDetailsBTN.setFont(new Font("Bell MT", Font.BOLD, 15));
		AccountDetailsBTN.setBounds(10, 174, 416, 23);
		AccountScreen.add(AccountDetailsBTN);

		JButton TransactionBTM = new JButton("View Transactions");
		TransactionBTM.setForeground(new Color(255, 255, 255));
		TransactionBTM.setBackground(new Color(0, 0, 0));
		TransactionBTM.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {

				JPanel TransactionPanel = new JPanel();
				TransactionPanel.setBackground(new Color(128, 128, 128));
		...
		TransactionBTM.setFont(new Font("Bell MT", Font.BOLD, 15));
		TransactionBTM.setBounds(10, 208, 416, 23);
